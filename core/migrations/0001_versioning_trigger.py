...
# python manage.py makemigrations core --name versioning_trigger --empty

from django.db import migrations

# https://github.com/nearform/temporal_tables/blob/master/versioning_function.sql
CREATE_TEMPORAL_SQL = """-- version 1.2.0
/*
versioning(
    sys_period: str
    history_table: str
    mitigate_update_conflicts: str
    ignore_unchanged_values: bool = false;
    include_current_version_in_history: bool = false;
...
class Migration(migrations.Migration):
    dependencies = []
    operations = [migrations.RunSQL(CREATE_TEMPORAL_SQL, "DROP FUNCTION versioning;")]
